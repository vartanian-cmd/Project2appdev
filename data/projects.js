...
const projects = [
  ...
  },
  {
    ...
    description: "This was a solo project made to display a usage for the popular A* Search algorithm. In this project I recreated the popular game Pacman with the enemies (Ghosts) using an A* search alogrithm to locate and track down the player (Pacman). ",
    ...
    excerpt: "A personalized password manager that works accross all devices and all applications",
