...
const posts = [
  ...
  },
  {
    ...
    coverImage: ai,
    tags: ["AI", "Career",],
    content: "For this course we are allowed AI to assist us with projects, a question that keeps occuring is if I can't do it but AI can do it within seconds how is this going to effect my future, how do I proceed with improving to the point where I am better than AI to companies? I've made it a goal to use AI conversatively I don't want it to do something and I have zero understanding and ship it off for the future and present students doing this how will it effect job opprunities, technical interviews, ect. This job market is hard enough are we coming to the point where its almost impossible?",
  },
];
